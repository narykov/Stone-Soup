...
from stonesoup.denbridge.multi_plot import get_subplot_idx, plot_tracks, get_subplot_coords, draw_connection, plot_track, plot_detections
...
lims = {'xlim': [-0.5*rng_instrumental, 0], 'ylim': [0, 0.4*rng_instrumental]}
...
# rng_pixels = np.floor(rng_instrumental / rng_delta).astype(int)  # how many
...
V_BOUNDS = np.array([lims['xlim'],   # (x_min, x_max)
                     lims['ylim']])  # (y_min, y_max)
